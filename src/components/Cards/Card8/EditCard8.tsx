...
const EditCard8 = ({ title, description, color = '' }: Props) => {
  ...
  const handleUploadClick = () => document.getElementById("hiddenFileInput8")?.click();
    ...
    <div className="col-start-11 col-end-13 row-start-6 row-end-13" style={{ width: '100%' }}>
      ...
      >
        ...
        <div className="flip-front">
          <div style={{ display: 'flex', flexDirection: 'row' }}>
            ...
            <div style={{ minHeight: 0, flex: 1 }}>
              ...
              {/* TEXTAREA DESCRIPTION (like card 5) */}
              <textarea
        ...
        >
          ...
          <input type="file" id="hiddenFileInput8" style={{ display: "none" }} onChange={handleFileChange} />
